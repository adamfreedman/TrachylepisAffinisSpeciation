...
#************** "anc_sym_mig"
#5 Values
anc_sym_mig_params = [1.6073,0.9357,0.4194,1.1379,0.0001]

#************** "anc_asym_mig"
#6 Values
anc_asym_mig_params = [1.314,0.7726,0.5405,0.3786,0.6864,0.0132]

#************** "sec_contact_sym_mig"
#5 Values
sec_contact_sym_mig_params = [5.9468,3.9501,0.1539,5.8349,0.9772]

#************** "sec_contact_asym_mig"
#6 Values
sec_contact_asym_mig_params = [2.0221,1.2461,0.5396,0.655,1.3719,0.2081] 

#************** "no_mig_size"
#6 Values
no_mig_size_params = [0.6174,0.5117,19.6456,1.7427,0.1582,0.0283] 

#************** "sym_mig_size"
#7 Values
sym_mig_size_params = [0.1718,0.377,2.2999,1.1642,0.3878,0.3806,0.4388]

#************** "asym_mig_size"
#8 Values
asym_mig_size_params = [0.7979,1.7832,4.103,2.1058,0.4624,0.1306,3.4901,0.2347] 

#************** "anc_sym_mig_size"
#7 Values
anc_sym_mig_size_params = [1.6991,1.2681,21.3764,5.5745,0.2947,2.6352,0.0668]

#************** "anc_asym_mig_size"
#8 Values
anc_asym_mig_size_params = [0.7289,0.9513,28.0454,1.3005,0.8164,0.3982,1.2479,0.0321] 

#************** "sec_contact_sym_mig_size"
#7 Values
sec_contact_sym_mig_size_params = [0.4177,1.4007,3.319,1.4237,0.411,0.8413,0.2989]

#************** "sec_contact_asym_mig_size"
#8 Values
sec_contact_asym_mig_size_params = [0.3459,0.2079,2.9357,1.2619,0.4114,0.3828,0.3191,0.4719]
